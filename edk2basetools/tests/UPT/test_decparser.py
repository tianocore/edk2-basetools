...
class CleanStringTestCase(unittest.TestCase):
    ...
    def test_clean_string_cpp(self):
...
class MacroParserTestCase(unittest.TestCase):
    ...
    def testCorrectMacro(self):
        ...
        self.assertFalse('MACRO1' not in self.dec._LocalMacro)
...
class DecTestTop(_DecBase):
    ...
    def _ParseItem(self):
        TestParser = DecTestInner(self._RawData)
        TestParser.Parse()
...
class ParseTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        [TOP]
          sub-item
        '''
        dec = DecTestTop(FileContent('dummy', Content.splitlines()))
        dec.Parse()
...
class DecLibraryTestCase(unittest.TestCase):
    ...
    def test_libclass_relative(self):
...
class DecDecCommentTestCase(unittest.TestCase):
    def testDecHeadComment(self):
        ...
        self.assertEqual(dec._HeadComment[0][0], '## @file abc')
