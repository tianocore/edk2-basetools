...
class MyOptionParser():
    ...
    def GetOption(self):
        ...
        Parser.add_option("-c", "--case-insensitive", action="store_true", dest="CaseInsensitive",
        ...
        Parser.add_option("-N", "--no-cache", action="store_true", dest="DisableCache",
                          default=False, help="Disable build cache mechanism")
        Parser.add_option("--conf", action="store", type="string", dest="ConfDirectory",
                          help="Specify the customized Conf directory.")
        Parser.add_option("--check-usage", action="store_true", dest="CheckUsage", default=False,
        ...
        Parser.add_option("--hash", action="store_true", dest="UseHashCache", default=False,
