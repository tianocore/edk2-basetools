...
- run `pip install antlr4-python3-runtime==4.7` based on the original build environment.

5. Build the platform:

- Run env setting command: `edksetup.bat rebuild`
- Run Build Command: `build -p OvmfPkg\OvmfPkgIa32X64.dsc -a IA32 -a X64 -j build.log`
