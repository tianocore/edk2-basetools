...
from edk2basetools.Common.LongFilePathSupport import LongFilePath, CopyLongFilePath
...
from edk2basetools.Common.StringUtils import NormPath, GetSplitList
from collections import defaultdict
from edk2basetools.Workspace.WorkspaceCommon import OrderedListDict
...
from edk2basetools.GenPatchPcdTable.GenPatchPcdTable import parsePcdInfoFromMapFile
from edk2basetools.Workspace.MetaFileCommentParser import UsageList
from .GenPcdDb import CreatePcdDatabaseCode
from edk2basetools.Common.caching import cached_class_function
from edk2basetools.AutoGen.ModuleAutoGenHelper import PlatformInfo, WorkSpaceInfo
import json
import tempfile
...
class ModuleAutoGen(AutoGen):
    ...
    def _ApplyBuildRule(self, File, FileType, BinaryFileList=None):
        ...
        while Index < len(SourceList):
            ...
            if FileType in RuleChain:
                EdkLogger.error("build", ERROR_STATEMENT,
                                "Cyclic dependency detected while generating rule for %s" % str(Source))
    ...
    def CanSkipbyMakeCache(self):
        ...
        FfsDir = path.join(GlobalData.gBinCacheSource, self.PlatformInfo.OutputDir, self.BuildTarget +
                           "_" + self.ToolChain, TAB_FV_DIRECTORY, "Ffs", self.Guid + self.Name)
    ...
    def CanSkipbyPreMakeCache(self):
        ...
        if not GlobalData.gBinCacheSource:
            ...
            try:
                ...
                EdkLogger.quiet("[cache error]: fail to load PreMakeHashFileList file: %s" %
                                PreMakeHashFileList_FilePah)
